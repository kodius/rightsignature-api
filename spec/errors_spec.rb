...
describe RightSignature2013::ResponseError do
  describe "For OAuth response" do
    before do
      @net_http_response = Net::HTTPSuccess.new('1.1', '200', 'OK')
      @error = RightSignature2013::ResponseError.new(@net_http_response)
    end
    ...
    describe "message" do
      ...
      it "should return specified message" do
        error = RightSignature2013::ResponseError.new(@net_http_response, "No Way")
    ...
    describe "detailed_message" do
      it "should return error message from xml" do
        ...
        error = RightSignature2013::ResponseError.new(response)
  ...
  describe "For HTTParty response" do
    ...
    describe "message" do
      ...
      it "should return specified message" do
        error = RightSignature2013::ResponseError.new(@response, "No Way")
        error.message.should == 'No Way'
      end
    end
