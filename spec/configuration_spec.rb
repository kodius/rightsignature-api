...
describe RightSignature2013 do
  describe "load_configuration" do
    it "should load api_token into configurations[:api_token]" do
      rs = RightSignature2013::Connection.new(:api_token => "MyToken")
    ...
    it "should load OAuth consumer key, consumer secret, access token and access secret" do
      rs = RightSignature2013::Connection.new(:consumer_key => "key", :consumer_secret => "secret", :access_token => "atoken", :access_secret => "asecret")
  ...
  describe "check_credentials" do
    it "should raise error if configuration is not set" do
      rs = RightSignature2013::Connection.new()
    ...
    it "should raise error if api_token is blank and oauth credentials are not set" do
      rs = RightSignature2013::Connection.new(:api_token => " ")
      lambda {rs.check_credentials}.should raise_error
    end

    it "should raise error if consumer_key, consumer_secret, access_token, or access_secret is not set" do
      rs = RightSignature2013::Connection.new(:consumer_secret => "secret", :access_token => "atoken", :access_secret => "asecret")
      lambda {rs.check_credentials}.should raise_error

      rs = RightSignature2013::Connection.new(:consumer_key => "key", :access_token => "atoken", :access_secret => "asecret")
      lambda {rs.check_credentials}.should raise_error

      rs = RightSignature2013::Connection.new(:consumer_key => "key", :consumer_secret => "secret", :access_secret => "asecret")
      lambda {rs.check_credentials}.should raise_error

      rs = RightSignature2013::Connection.new(:consumer_key => "key", :consumer_secret => "secret", :access_token => "atoken")
      lambda {rs.check_credentials}.should raise_error
    end
    ...
    it "should not raise error if api_token is set" do
      rs = RightSignature2013::Connection.new(:api_token => "asdf")
      rs.check_credentials
    end
  end
  ...
  describe "has_api_token?" do
    ...
    it "should be true if api_token is set" do
      rs = RightSignature2013::Connection.new(:api_token => "abc")
